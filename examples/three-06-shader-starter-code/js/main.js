...
const boxMaterial = new THREE.MeshStandardMaterial({ color: 0xff0000, wireframe: true, }); // green
// const boxMaterial = new THREE.MeshNormalMaterial(); //  if you want to video normal material = colors relate to x, y, z axes
